            ...
            <section className="home-cats">
                ...
                <div className="home-cats-grid">
                    <Link to="/joyeria" className="home-cat-card home-cat-large">
                        <img src="/src/assets/home_joyeria.jpg" alt="Anillos" />
                    ...
                    <Link to="/lingotes" className="home-cat-card">
                        <img src="/src/assets/home_lingotes.jpg" alt="Lingotes de Oro" />
                        <div className="home-cat-overlay">
                    ...
                    <Link to="/joyeria" className="home-cat-card">
                        <img src="/src/assets/home_collares.jpg" alt="Collares" />
                        <div className="home-cat-overlay">
                    ...
                    <Link to="/lingotes" className="home-cat-card">
                        <img src="/src/assets/home_lingotePlata.jpg" alt="Lingotes de Plata" />
                        <div className="home-cat-overlay">
