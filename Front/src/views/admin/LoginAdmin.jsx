...
export default function LoginAdmin() {
    ...
    const handleSubmit = (e) => {
        ...
        const esAdmin = email === "admin@aurea.com" || email === "gestion@aurea.com";
        if (!esAdmin) { setError("Credenciales no autorizadas para este portal."); return; }
        login({
            nombre: "Admin AUREA",
            email,
            telefono: "",
            ...
            <main className="login-admin-main">
                ...
                <div className="login-admin-card">
                    <form onSubmit={handleSubmit}>
                        ...
                        <button type="submit" className="login-admin-btn">VERIFICAR CREDENCIALES</button>
                    </form>
                </div>
                ...
                <p className="login-admin-hint">Usar: admin@aurea.com</p>
            </main>
